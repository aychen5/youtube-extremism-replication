...
f_time_mainstream_all <- formula(minutes_activity_yt_video_time_elapsed_capped_total_mainstream_all_week ~  rr_cts + jw_cts + fem_cts + age + gender + educ2 + race)
...
predicted_data[channel_type == "alternative", y_max := 200]
predicted_data[channel_type == "extremist", y_min := 0]
predicted_data[channel_type == "extremist", y_max := 50]
